...
bool stokenizer::done(){
    ...
    if(_buffer[_pos]==NULL){return true;}
    else{return false;}

}
bool stokenizer::more(){

    if(_buffer[_pos]==NULL){return false;}
    else{return true;}
...
/*  every table filler marked by [--] is individually verified by the user
 *
 *  Success States
 *
 *     <-(0)->
